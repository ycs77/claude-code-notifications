# Claude Code 提示音 - 二階堂希羅 (Linux)

在 Claude Code 需要互動、提問或停止時，自動播放提示音通知用戶。

## 功能特色

- 🔔 **PermissionRequest 事件**: 當 Claude Code 跳出權限對話框、需要你授權時播放提示音
...
/plugin install notification-nikaidouhiro-linux@ycs77-notifications
```
